                    ...
                    <tr data-entry-id="{{ $trajet->id }}">
                      ...
                      <td>{{ $trajet->arrival_time }}</td>
                                ...
                                <td>
                                    ...
                                    <a href="{{Route('trajets.show',$trajet->id)}}" class="btn btn-info">Show</a>
                                    <a href="{{ Route('trajets.edit', $trajet->id) }}" class="btn btn-warning">Edit</a>
                                    <form action="{{ route('trajets.destroy', $trajet->id) }}"  onsubmit="return confirm('Delete trajet?')" method="POST" style="display:inline-block;">
                                        @csrf
                                        @method('DELETE')
